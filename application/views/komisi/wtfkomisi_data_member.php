            ...
            <div class="card-body table-responsive">
                ...
                <table class="table table-hover" id="dataTable">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        $member = $this->fungsi->getscmember($row->tgl_gajian);
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="<?= site_url('komisi/process') ?>" method="post">
                                        <!-- hidden input -->
                                        <input type="hidden" name="mkomisi_id" value="<?= $data->mkomisi_id ?>">
                                        <input type="hidden" name="user_id" value="<?= $data->user_id ?>">
                                        <input type="hidden" name="diterima" value="<?= $data->diterima ?>">
                                        <input type="hidden" name="status" value="selesai">

                                        <button name="memberwtf" class="btn btn-primary" onclick="return confirm('Apakah anda yakin sudah Transfer Komisi Rp. <?= number_format($data->diterima) ?> ke Rekening <?= $data->rekening ?> ?')">
                                            <i class="fa fa-hand-holding-usd"></i> Selesai
                                        </button>
                                        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#ModalRekapkomisi<?= $data->user_id ?>"><i class="fa fa-info-circle"></i> Details</button>
                                    </form>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="ModalRekapkomisi<?= $data->user_id ?>Label">Details Info( <?= $data->username ?> )</h5>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <!-- input -->
                                                <input type="number" name="komisi_member" id="komisi_member" class="form-control cin-komisi" value="<?= $data->komisisales ?>" readonly>
                                            </div>
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <!-- input -->
                                                <input type="number" name="lainlain" id="lainlain" class="form-control cin-lainlain" value="<?= $data->lainlain ?>" readonly>
                                            </div>

...
<div class="row">
    ...
    <div class="col">
        <a href="<?= site_url() ?>komisi/printcs/<?= $this->uri->segment(3) ?>" class="btn btn-default btn-icon-split float-right" onclick="return confirm('Ingin Print Laporan Pembayaran Komisi <?= $row->tgl_gajian ?> ??')">

                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td> <?= $data->nama_cs ?></td>
                                <td><span class="badge badge-<?= $data->status == 'processing' ? 'warning' : ($data->status == 'packing' ? 'info' : ($data->status == 'delivery' ? 'info' : ($data->status == 'completed' ? 'success' : ($data->status == 'on-hold' ? 'secondary' : 'danger')))) ?> p-2"><?= $data->status ?> </span> </td>
                                <td> <?= $data->order_id ?></td>

                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-user" id="username" name="username" placeholder="Username.." value="<?= $this->input->post('username') ?? $row->username ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control form-control-user" id="email" name="email" placeholder="example@ex.com" value="<?= $this->input->post('email') ?? $row->email ?>">
                            </div>
                            <div class="form-group">
